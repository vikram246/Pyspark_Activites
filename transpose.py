...
def CSVParsingTBL_1():
    ...
    hasattr(rdd3, "toDF")
    rdd4 = rdd3.toDF().drop('_3','_4','_5','_6')
    ...
    rdd6 = transpose(rdd4).toDF("Device ID_1", "Test Start time_1", "Test Finish time_1", "Mask_1", "Lot_1", "Wafer",
                  ...
                  "SpecName", "SpecRev", "SubProcess", "Test SW Version", "DateCruncherVersion", "DummyPwr", "NUll")
    rdd7 =  rdd6.filter(col("_1").like("NA"))
    rdd7.show()
    # rdd7.toPandas().to_csv("D:\Spark/spark_outputs/file3.csv")
